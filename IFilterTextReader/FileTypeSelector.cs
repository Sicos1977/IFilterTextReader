...
namespace IFilterTextReader
{
    ...
    public class FileTypeSelector
    {
        ...
        private static List<FileTypeFileInfo> GetFileTypes()
        {
            ...
            // MP4
            fileTypes.Add(new FileTypeFileInfo(new byte[] { 0x00, 0x00, 0x00, 0x18, 0x66, 0x74, 0x79, 0x70, 0x6D, 0x70, 0x34 }, ".mp4", "MPEG-4 Part 12: ISO base media file format"));
        ...
        /// Null is returned when the filetype could not be determined
        /// </summary>
